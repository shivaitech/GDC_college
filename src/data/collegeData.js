...
export const teachingStaff = [
  ...
  { id: 4,  name: 'डॉ. दीपा शर्मा',           nameEn: 'Dr. Deepa Sharma',             designation: 'Assistant Professor, Sociology',                designationHindi: 'सहायक प्राध्यापक, समाजशास्त्र',     email: 'Deepaarv18@gmail.com',         isPrincipal: false, avatar: 'DS',  photo: fp('deepa.jpeg') },
  ...
  { id: 13, name: 'श्री नरेश राणा',           nameEn: 'Mr. Naresh Rana',              designation: 'Yoga Instructor, Arts Faculty Group',           designationHindi: 'योग प्रशिक्षक, कला संकाय',           email: 'Nareshrana640@gmail.com',      isPrincipal: false, avatar: 'NR',  photo: fp('naresh.png') },
